...
$nomor_surat = 'AP.I.JOG.001/PL.02/PST/2019-B';

?>
<!-- Content Header (Page header) -->
<section class="content-header">
    <h1><center>Tambah Surat Lelang/Penunjukan Langsung</center></h1>
</section>
...
<section class="content">
    <div class="box">
        ...
        <div class="box-body">
            ...
            <?=form_open('surat-lelang-pl/tambah_surat', ['class' => 'form-horizontal', 'style' => 'width:70%;margin:auto;']); ?>
            ...
            <?=custom_dropdown(['label' => 'Kegiatan', 'name' => 'kegiatan'], $options = [
                'Pengumuman Pelelangan' => 'Pengumuman Pelelangan',
                'Pemberitahuan Penunjukan Langsung' => 'Pemberitahuan Penunjukan Langsung',
            ]) ?>
            ...
            <?=form_hidden('jenis', 'surat_lelang-pl'); ?>
