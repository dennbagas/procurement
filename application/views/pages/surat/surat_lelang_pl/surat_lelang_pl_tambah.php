...
<section class="content-header">
    <h1>
        <center>Tambah Surat Lelang/Penunjukan Langsung</center>
    </h1>
</section>
    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            <?=custom_dropdown('Pemesan', ['name' => 'pemesan'],
                $options = $pegawai, 'Pengumuman Pelelangan', ['id' => 'pemesan']) ?>
            <?=form_hidden('jenis', 'surat_lelang_pl'); ?>
...
<script>
    jQuery(document).ready(function () {
        ...
        $("#submit").click(function (event) {
            ...
            var url = "<?php echo base_url(); ?>" + "surat-lelang-pl/simpan";
            var data = {
