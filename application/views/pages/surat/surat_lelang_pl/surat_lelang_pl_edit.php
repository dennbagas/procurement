...
<section class="content-header">
    ...
    <h1>
        <center>Edit Surat Lelang/Penunjukan Langsung</center>
    </h1>
</section>
...
<section class="content">
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Edit Surat Lelang/Penunjukan Langsung</h3>
        </div>
        <div class="box-body">
...
<script>
    jQuery(document).ready(function () {
        $("#submit").click(function (event) {
            ...
            var url = "<?php echo base_url(); ?>" + "surat-lelang-plt/update";
            var data = {
                // id dari input form
                id: $("#id").val(),
