...
{
    // nama surat
    protected static $_segment = 'surat-gm';
    // jenis surat
    protected static $_jenis_surat = 'surat_gm';
    // format nomor surat
    protected static $_prefix_nomor_surat = 'AP.I.'; //awalan nomor surat
    protected static $_nomor_surat = '/PL.02/KTRK/2019/GM.JOG-B'; //akhiran  nomor surat
    ...
    public function index()
    {
        ...
        $this->load->view('pages/surat/surat_gm/surat_gm', $data);
    }
    ...
    public function edit($id)
    {
        ...
        $this->load->view('pages/surat/surat_gm/surat_gm_edit', $data);
    }
