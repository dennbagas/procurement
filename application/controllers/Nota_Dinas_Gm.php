...
class Nota_Dinas_Gm extends BASE_Controller
{
    ...
    {
        $this->load->view('pages/surat/nota_dinas_gm/nota_dinas_gm');
    }
        ...
        if ($this->surat_model->register($data) != false) {
            ...
            $this->session->set_flashdata('message',
                success_message(
                    ...
                    $url = base_url() . 'nota-dinas-gm',
                    $link = 'Lihat Daftar Surat'
                )
            );

            redirect('/nota-dinas-gm/tambah');
